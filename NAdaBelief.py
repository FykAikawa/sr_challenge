...
class Nadabelief(optimizer_v2.OptimizerV2):
  ...
  def __init__(self,
    ...
    super(Nadabelief, self).__init__(name, **kwargs)
  ...
  def _prepare(self, var_list):
    ...
    return super(Nadabelief, self)._prepare(var_list)
  ...
  def _resource_apply_dense(self, grad, var, apply_state=None):
    ...
    v_t = (coefficients['beta_2_t'] * v +
           coefficients['one_minus_beta_2_t'] * tf.square(grad-m_t))
  ...
  def _resource_apply_sparse(self, grad, var, indices, apply_state=None):
    ...
    v_scaled_g_values = tf,math.square(grad - m_t_bar) * coefficients['one_minus_beta_2_t']
  ...
  def get_config(self):
    config = super(Nadabelief, self).get_config()
    config.update({
